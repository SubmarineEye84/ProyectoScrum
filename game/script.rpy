...
define m = Character('Martín', color="#f0ed54")
define a = Character('Ana', color="#be0049")
define c = Character('Carlos', color="#0e91e9")
define mr = Character('María', color="#930aee")
define j = Character('Juan', color="#30be30")
define g = Character('Guia', color="#30be30")
...
label start:
    ...
    m "¡Chicos, parece que nos están invitando a aprender más sobre Scrum! Sabemos que Scrum es una metodología ágil utilizada para el desarrollo de proyectos, pero no sabemos mucho más. ¡Esta es una oportunidad emocionante para sumergirnos en el mundo de Scrum y descubrir sus secretos!"
...
label si:
    ...
    "Con esta introducción a Scrum y sus principales características, Martín y su equipo se preparan para embarcarse en su aventura y aprender más sobre esta metodología ágil. Están listos para enfrentar los desafíos que se les presenten y descubrir los secretos del Scrum en su viaje. La historia está lista para continuar con el primer acto: 'El llamado a la aventura'."

    scene bg montaña
    with fade

    "Martín y su equipo de Scrum Masters llegan al lugar remoto de la reunión, ansiosos por descubrir qué les espera. Se encuentran en una cabaña en la base de una imponente montaña, rodeados por un paisaje natural y salvaje. Aparece un guía local que los llevará en su aventura."
    ...
    "El equipo celebra su éxito y se prepara para continuar con su viaje hacia el destino final, ansiosos por descubrir más sobre Scrum y cómo aplicar sus enseñanzas en su trabajo diario. La historia está lista para avanzar al siguiente acto: (El encuentro con el Guardián del Conocimiento Ágil."
...
label equipo:
    ...
    mr "Pero siempre lo hemos hecho así, ¿por qué tenemos que cambiar ahora?"
